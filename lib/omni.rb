class Omni
  ...
  # bundles all classifications into 1 job
  # notifications are combined into 1 but it takes forever
  # and you can't tell from a failure notice which site(s) actually failed
  def classify2(user)
    require 'htmlentities'
